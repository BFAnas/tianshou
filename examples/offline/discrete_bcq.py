...
from examples.mujoco.mujoco_env import make_discrete_mujoco_env
...
def get_args():
    ...
    parser.add_argument(
        "--load-buffer-name", type=str, default="/data/user/R901105/dev/my_fork/tianshou/spi_buffer_dqn.hdf5"
    )
    parser.add_argument(
...
def test_discrete_bcq(args=get_args()):
    # envs
    env, _, test_envs = make_discrete_mujoco_env(
        args.task, args.seed, 1, args.test_num, obs_norm=False, action_per_branch=10
    )
