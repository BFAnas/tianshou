...
def run_command(combination, gpu_id):
    cmd = f"/data/user/R901105/.conda/envs/dev/bin/python /data/user/R901105/dev/my_fork/tianshou/train_halfcheetah.py --learn-type {combination[0]} --cede-ctrl-type {combination[1]} --cede-ctrl-nature {combination[2]} --device cuda:{gpu_id} --auto-alpha"
