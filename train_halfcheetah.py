...
class MixedPolicy(BasePolicy):
    ...
    def sigmoid_scheduler(self, t_max=1e5, initial_value=1., final_value=0., param=30):
        """
...
def main():
    ...
    parser.add_argument('--alpha', type=float, default=0.73, help='Alpha value')
    ...
    def test_fn(num_epoch: int, step_idx: int):        
        ...
        if mixed_policy.cede_ctrl_type == "normal":
            id_data = offline_data.sample(10000)[0].obs
