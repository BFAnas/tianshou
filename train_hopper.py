...
class MixedPolicy(BasePolicy):
    ...
    def sigmoid_scheduler(self, t_max=2e5, initial_value=1., final_value=0., param=1):
        """
...
def main():
    ...
    parser.add_argument('--task', type=str, default="Hopper-v2", help='Task name')
    parser.add_argument("--data-task", type=str, default="hopper-medium-v2")
    ...
    parser.add_argument('--alpha', type=float, default=0.36, help='Alpha value')
